...
import {ForCreate, ForUpdate, Laboratory, RawLaboratory} from "@/domain/types";
...
export interface ILaboratoryRepository {
    ...
    create(laboratory: ForCreate<RawLaboratory>): Promise<RawLaboratory>;
...
export class LaboratoryRepository implements ILaboratoryRepository {
    ...
    async create(laboratory: ForCreate<RawLaboratory>) {
        try {
